        ...
        <Row class="tt-row">
          ...
          栏目：
            <Select class="w-select" v-model="sonTab">
              ...
              <Option v-for="item in sonTabList" :value="item.id" :key="item.id">{{item.name}}</Option>
            </Select>
            &nbsp;&nbsp;&nbsp;&nbsp;
            状态：
            <Select class="w-select" v-model="publicationStatus">
              <Option value="9">全部</Option>
              <Option v-for="item in publicationStatusList" :value="item.id" :key="item.id">{{item.name}}</Option>
            </Select>
            &nbsp;&nbsp;&nbsp;&nbsp;
            文章：
...
<script>
import { Page, Tabs, TabPane, Select, Option } from "iview";
...
export default {
  ...
  data() {
    return {
      ...
      healthEducation:[
        ...
        {title:"阅读量",key:"readAmount",align:"center"},
        {title:"状态",key:"enable",align:"center",render:(h,params)=>{
          let enable = params.row.enable,btnText = "";
          if(enable == 1){
            btnText = "启用";
          }else{
            btnText = "禁用";
        ...
        {title:"栏目",key:"type",align:"center",render:(h,params)=>{
          let typeText = "全部";
        ...
        {title:"操作",key:"operate",align:"center",render:(h,params)=>{
          ...
          return [
            ...
            h("a",{
              on:{
                click:()=>{
                  this.changeEnable(params.index,params.row.id,api.educationUpdateFlag,enable);
                }
              }
            },text)
          ]
        ...
        {title:"操作",key:"operate",align:"center",render:(h,params)=>{
          ...
          return [
            ...
            h("a",{
              on:{
                click:()=>{
                  this.changeEnable(params.index,params.row.id,api.doctorclassicUpdateFlag,enable);
                }
              }
            },text)
          ]
        ...
        {title:"操作",key:"operate",align:"center",render:(h,params)=>{
          ...
          return [
            ...
            h("a",{
              on:{
                click:()=>{
                  this.changeEnable(params.index,params.row.id,api.recommendUpdateFlag,enable);
                }
              }
            },text)
          ]
  ...
  methods: {
    ...
    loadPage(pageNo){
      ...
      params.enable = parseInt(this.publicationStatus==9?null:this.publicationStatus);
