...
export default {
    ...
    created () {
        let breadList = [
            ...
            {
                path: "/index/operation/renewalDeposit",
                title: "住院押金续交对账"
            }
        ];
        ...
        progressbord() {
            ...
            this.$axios.post(url, params).then(res => {
                if(res.data.success) {
                    ...
                    // 进度条参数
                    let progressEnd = Boolean(ret.TOTAL_COUNT) ? Number(ret.TOTAL_COUNT) : 0
                    ...
                    // 当已对账数量 EXECUTE_START+异常数据 ERROR_COUNT = 总数的时候停止递归然后调用取消对账接口
