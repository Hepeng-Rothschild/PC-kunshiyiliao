    ...
    this.$axios
      ...
      .then(resp => {
        ...
        this.tryCatch(this.info.idcardFront) &&
          (this.idcardFront =
            this.fileBaseUrl + this.tryCatch(this.info.idcardFront).fileName);

        this.tryCatch(this.info.idcardBack) &&
          (this.idcardBack =
            this.fileBaseUrl + this.tryCatch(this.info.idcardBack).fileName);
        ...
        this.tryCatch(this.info.prescriptionSignature) &&
          (this.prescriptionSignature =
            this.fileBaseUrl +
            this.tryCatch(this.info.prescriptionSignature).fileName);
