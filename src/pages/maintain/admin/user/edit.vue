        ...
        this.$axios
            ...
            .then(res => {
                if (res.data.code) {
                    ...
                    if(this.identity == 1){}else if(this.identity == 2){
                      this.provinceList.push(this.$store.getters.getProvinceById(ret.identityCoding));
                      this.provinceId = this.provinceList[0].id ;
                    }else if(this.identity == 3){
                      this.provinceList.push(this.$store.getters.getProvinceByCityId(ret.identityCoding));
                      this.provinceId = this.provinceList[0].id;
                      this.cityList.push(this.$store.getters.getCityById(ret.identityCoding)) ;
                      this.cityId = this.cityList[0].id ;
                    }else if(this.identity == 4){
                      this.areaList.push(this.$store.getters.getAreaById(ret.identityCoding));
                      this.cityList.push(this.$store.getters.getCityByAreaId(ret.identityCoding));
                      this.cityId = this.cityList[0].id;
                      this.provinceList.push(this.$store.getters.getProvinceByCityId(this.cityId));
                      this.provinceId = this.provinceList[0].id;
                    }else if(this.identity == 5){
                      this.hospitalList = [{id:this.hospitalId,orgName:ret.hospitalName}]
                    }
                    if (Boolean(ret.userIcon)) {
                        this.uploadList.push({
                            ...
                            url:
                                this.fileBaseUrl +
                                this.analysisImages(ret.userIcon)
                        });
                    }
                } else {
